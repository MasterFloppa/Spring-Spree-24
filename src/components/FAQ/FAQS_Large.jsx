	...
	return (
		<div className='w-full h-[1100px] bg-purple flex flex-col'>
			<div className='flex flex-col mt-32'>
				<div className='flex justify-center text-pink font-aftersick text-4xl mt-10 mb-10 faq-title'>FAQS</div>
				<div className='tabs relative flex justify-start bg-purple2 text-pink rounded-3xl shadow-2xl md:ml-8 w-[200px]'>
					...
					<input type='radio' id="Food & Accomdation" name="group" checked={selectedTab === 'Food & Accomdation'} onChange={handleTabChange} />
					<input type='radio' id="Pro Shows" name="group" checked={selectedTab === 'Pro Shows'} onChange={handleTabChange} />
					<div className="flex flex-col w-full mt-2 mb-2  items-center justify-around labels">
					...
					<div className='content'>
						...
						<div className='contentBx' htmlFor="Pro Shows"> <Accordions faqs={faqs4} /></div>
