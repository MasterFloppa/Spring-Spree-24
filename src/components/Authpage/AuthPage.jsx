...
const AuthPage = () => {
	...
	function handleButtonClick() {
		window.open(
			'https://docs.google.com/forms/d/e/1FAIpQLScIHElFZUxygWcTLhQXg6CLxQMWRXoVmkNch_jsUOTNHdI22w/viewform?pli=1',
			'_blank'
		);
	}

	return (
		<div className='flex min-h-screen flex-col justify-center items-center bg-black' style={{ paddingTop: '25%' }}>
			<style>
				{
			...
			<img className='rasenganIMG' src={rasengan} alt="rasengan" style={{ 'position': 'absolute', 'top': '10%', 'zIndex': '1' }} />
			...
			<div id='regi' className="main flex justify-center">
