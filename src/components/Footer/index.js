            ...
            <div className="w-full h-full flex justify-center items-center">
              ...
              <div className="w-auto h-auto flex flex-col absolute ">
                ...
                <div className="flex-col justify-center items-center mb-4">
                  <div>
                    <h3 className="block uppercase flex justify-center text-purple text-lg font-semibold">
                      USEFUL LINKS
                    </h3>
                    <div className="w-2/5 ml-[320px] flex items-center justify-around">
                      <div className="Links cursor-pointer text-purple font-medium text-lg hover:text-purple font-weight-600 block pb-2 text-md pt-2">
