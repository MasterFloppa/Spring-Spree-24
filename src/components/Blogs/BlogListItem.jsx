...
const BlogListItem = props => {
    ...
    let redirect = encodeURIComponent(currentURL + "/" + props.blog.id);                //Prevents XSS
    return (
        <div className="mt-1 mb-4 flex flex-col items-center">
            ...
            <div className="flex items-center justify-center mt-4">
                <a href={redirect} className="relative inline-flex items-center justify-center p-3 px-4 py-2 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-purple-500 rounded-full shadow-md group">
