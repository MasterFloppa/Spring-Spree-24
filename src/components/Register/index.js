...
export const Register = () => {
	...
	return !allComplete() ? (
		<div class="min-h-screen overflow-y-auto flex items-center justify-center bg-black">
			<section class="max-w-4xl mx-2 p-6 lg:mx-auto bg-gray rounded-md shadow-md mt-20 mb-20">
				...
				<form >
					<div class="grid grid-cols-1 gap-6 mt-4 md:grid-cols-2">
						...
						<div>
							...
							<input required={true} id="college" onChange={handleTextChange} placeholder="College Name" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" />
						</div>

						<div className='text-white'>
							<label for="gender">Gender:</label>
							<br />
							<select id="gender" onChange={handleDropdownChange} name="gender" class="w-full px-4 py-2 mt-2 text-black bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
						...
						{/* 
            <div>
              <label class="text-white dark:text-gray-200" for="username">Referral Code:</label>
              <input id="referralId" type="text" placeholder="Optional" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" />
            </div> */}
						<div>
							<h2 class="text-white dark:text-gray-200 mb-2">Registration:</h2>
						...
						<div>
							<h2 class="text-white dark:text-gray-200 mb-2">Food & Accomodation:</h2>
					...
					<div className="mt-6">
						<h2 class="text-white dark:text-gray-200 mb-2">Pro Shows:</h2>
					...
					{amount === 350 ? (<div class="flex justify-center mt-6">
						<button onClick={handleSubmit} class="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-gray rounded-md hover:bg-pink-700 focus:outline-none focus:bg-gray-600" disabled={amount === 0} >Pay Registration Fee Rs. 350</button>
					</div>) : (<div class="flex justify-center mt-6">
						<button onClick={handleSubmit} class="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-gray rounded-md hover:bg-pink-700 focus:outline-none focus:bg-gray-600" disabled={amount === 0} >{amount === 0 ? `Select atleast 1 day` : `Pay Rs. ${amount}`}</button>
					</div>)}
